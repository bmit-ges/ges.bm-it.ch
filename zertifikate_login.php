...
<body style="background-color:#000000;">
  ...
  <div id="zert-line"></div>

  <!---- IMS F Zertifikat---->

  <img id="zertifikat1" src="bilder/imsf.jpg" alt="imsf">
  ...
  <div id=zert-p1>
    ...
    <img id="zertifikat2" src="bilder/beobachtungsschwerpunk.jpg" alt="beobachtungsschwerpunk">
    ...
    <!--Multicheck-->
    <img id="zertifikat3" src="bilder/multicheck.jpg" alt="multicheck">
    ...
    <!--ECDL Basic-->
    <img id="zertifikat4" src="bilder/coming-soon.jpg" alt="coming-soon">
    ...
    <img id="zertifikat5" src="bilder/coming-soon.jpg" alt="coming-soon">
    ...
    <img id="zert-arrow-right" src="bilder/arrow_right.png" alt="zert_arrow_right">
